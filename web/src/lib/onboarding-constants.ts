...
export const ONBOARDING_TRADES: TradeRow[] = [
  ...
  { group: "Shell", id: "drywall", label: "Drywall", icon: "🧱", defaultChecked: true },
  { group: "Finish", id: "tile", label: "Tile", icon: "🔵", defaultChecked: false },
  { group: "Finish", id: "painting", label: "Painting", icon: "🎨", defaultChecked: true },
  { group: "Finish", id: "flooring", label: "Flooring", icon: "🪵", defaultChecked: false },
  { group: "Finish", id: "trim", label: "Trim and Millwork", icon: "🪚", defaultChecked: false },
  { group: "Finish", id: "cabinets", label: "Cabinets and Tops", icon: "🚪", defaultChecked: false },
  { group: "Finish", id: "finishing", label: "Finishing", icon: "✨", defaultChecked: false },
  { group: "Exterior", id: "roofing", label: "Roofing", icon: "🏠", defaultChecked: false },
  { group: "Exterior", id: "deck_fence", label: "Deck Fence Sheds", icon: "🪵", defaultChecked: false },
  { group: "Exterior", id: "landscaping", label: "Landscaping", icon: "🌿", defaultChecked: false },
  { group: "Specialty", id: "lowvolt", label: "Low Voltage", icon: "📡", defaultChecked: false },
  { group: "Specialty", id: "security", label: "Security", icon: "🔒", defaultChecked: false },
  { group: "Specialty", id: "cleaning", label: "Cleaning", icon: "🧹", defaultChecked: false },
];
