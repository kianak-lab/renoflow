...
const ROOM_TYPES = [
  ...
  },
  {
    n: "Bathroom",
    ic: "🚿",
    trades: ["demo", "framing", "electrical", "plumbing", "insulation", "drywall", "tile", "painting", "doors-trim"],
  },
  {
    n: "Bedroom",
    ic: "🛏",
    trades: ["demo", "electrical", "insulation", "drywall", "flooring", "painting", "doors-trim"],
  },
  {
    n: "Living Room",
    ic: "🛋",
    trades: ["demo", "electrical", "drywall", "flooring", "painting", "doors-trim"],
  },
  {
    n: "Basement",
    ic: "⬇",
  ...
  },
  {
    n: "Laundry",
    ic: "🫧",
    trades: ["demo", "electrical", "plumbing", "drywall", "flooring", "painting", "doors-trim"],
  },
