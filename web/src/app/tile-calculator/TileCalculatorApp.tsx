...
export function TileCalculatorApp() {
      ...
      <div className="content">
        ...
        <div className={"panel" + (tab === "substrate" ? " active" : "")} id="panel-substrate" role="tabpanel">
          ...
          <div className="card" id="substrateInfo">
            <div className="card-row">
              <div>
                <div style={{ fontSize: 13, color: "var(--text)", fontWeight: 500 }}>{dSub.name}</div>
                <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 4, lineHeight: 1.5 }}>{dSub.note}</div>
              </div>
            </div>
          </div>
          <div className="gap" />
      ...
      <div className="bottom-bar">
        <div className="bottom-inner">
          <div className="total-wrap">
            <div className="total-label">Est. Supply</div>
